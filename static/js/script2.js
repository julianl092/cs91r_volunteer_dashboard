...
var active = d3.select(null);
      var svg = d3.select(".hero-body").append("svg")
      ...
      function ready(us) {
          ...
          g.append("path")
            ...
            var marks = []
             ...
             // var marks = [{long:  Math.random() * (width - 0) + width, lat: 90},{long: 160, lat: 115},{long: 200, lat: 150}];
...
var dataset = d3.range(n).map(function(d) { return {"y": d3.randomUniform(1,900)() } })
